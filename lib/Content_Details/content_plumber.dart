...
class content_plumber extends StatefulWidget {
  final Map<String, dynamic> item;
  content_plumber({required this.item});

  @override
  State<content_plumber> createState() => _content_plumberState();
}

class _content_plumberState extends State<content_plumber> {
  double _rating = 3.0;
